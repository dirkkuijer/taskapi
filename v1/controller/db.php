...
class DB {
	...
	public static function connectionWriteDB() {
		if(self::$writeDBConnection === null) {
				self::$writeDBConnection = new PDO('mysql:host=localhost;dbname=udemy;charset=utf8', 'root', '');
	...
	public static function connectionReadDB() {
		if(self::$readDBConnection === null) {
				self::$readDBConnection = new PDO('mysql:host=localhost;dbname=udemy;charset=utf8', 'root', '');
